...
[nmap  -PE/-PP/-PM](#nmap%C2%A0%20-PE%2F-PP%2F-PM "nmap%20%20-PE/-PP/-PM)



[二：端口扫描及其原理](#2.端口扫描及其原理)
...
[简单扫描(nmap ip)](#简单扫描(nmap%20ip))



[全面扫描(nmap -A ip)](#全面扫描(nmap%20-A%20ip))



[探测指定端口的开放状态](#探测指定端口的开放状态)



[探测N个最有可能开放的端口](#探测N个最有可能开放的端口")
...
[IP诱骗(IP decoys)](#IP诱骗(IP%20decoys))
...
相关文章：[Nmap 进阶使用 \[ 脚本篇 \]](https://cloud.tencent.com/developer/article/1627317 "Nmap 进阶使用 [ 脚本篇 ]")
